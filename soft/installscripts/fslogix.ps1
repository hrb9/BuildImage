...
$LocalPath = 'C:\\fslogix'
$WVDflogixURL = 'https://raw.githubusercontent.com/hrb9/BuildImage/main/soft/source/FSLogix.ps1'
...
.\\FSLogixSetup.ps1 -ProfilePath \\baramwayfs01.file.core.windows.net\fslogix\ -Verbose 
